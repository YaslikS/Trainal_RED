...
class EmailTextFieldRegisWidget extends StatefulWidget {
  ...
  @override
  State<EmailTextFieldRegisWidget> createState() => _EmailTextFieldRegisWidgetState();
}

class _EmailTextFieldRegisWidgetState extends State<EmailTextFieldRegisWidget> {
  @override
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Text(
          'The specified email address will be used to log in to the application.',
